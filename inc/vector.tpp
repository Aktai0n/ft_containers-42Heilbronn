...
/*   Updated: 2022/05/28 22:35:51 by skienzle         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
vector<T,Alloc>::insert(iterator position, const value_type& val)
{
	size_type index = static_cast<size_type>(ft::distance(this->begin(), position));
...
vector<T,Alloc>::insert(iterator position, size_type n, const value_type& val)
{
	...
	ft::copy_backward(this->_begin + index, this->_begin + old_size, this->_begin + old_size + n);
	ft::fill(this->_begin + index, this->_begin + index + n, val);
}
